-- Allow deletion of any workspace with exactly one member.
--
-- Workspace deletion remains membership-scoped, but it is no longer tied to
-- the personal workspace ID convention.
