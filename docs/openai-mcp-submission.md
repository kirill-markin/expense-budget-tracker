...
| Version under evaluation | 1.2.1 |
...
| Runtime version | 1.2.1 unless a later aligned version is promoted |
...
| Registry manifest identity/version | `com.expense-budget-tracker/expense-budget-tracker` / `1.2.1` |
