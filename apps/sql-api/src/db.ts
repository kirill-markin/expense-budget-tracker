...
/**
 * The active-status allowlist is shared with the web app and the auth service,
 * so one vocabulary governs every surface that admits an identity.
 */
export { isActiveUserStatus } from "@expense-budget-tracker/agent-shared/account-status";
