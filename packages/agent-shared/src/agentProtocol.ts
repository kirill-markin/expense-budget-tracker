...
Relation operations: ledger_entries, budget_lines, workspace_settings, and account_metadata support SELECT and, under existing write-approval rules, INSERT, UPDATE, and DELETE; budget_adjustments, the derived accounts view, and global worker-owned fx_rates_raw and fx_rates_daily relations are SELECT-only. Only allowlisted relations are reachable; internal and security-related relations are blocked.
